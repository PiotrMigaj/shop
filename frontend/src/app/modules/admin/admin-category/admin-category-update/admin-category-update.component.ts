...
export class AdminCategoryUpdateComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private adminCategoryService:AdminCategoryService,private route:ActivatedRoute,private snackBar:MatSnackBar,private adminMessageService:AdminMessageService){}
  ...
  submit(){
    ...
    .subscribe({
      next: category => {
        ...
        this.snackBar.open("Kategoria zostala zapisana","",{duration:3000});
      },
      error: err => {}
    })
  }
